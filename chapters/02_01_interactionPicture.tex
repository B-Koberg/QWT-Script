...
Zur Herleitung der Wellenfunktion im WW-Bild benutzen wir die Picture-Unabhaengigkeit des
Erwartungswertes:
\begin{equation}
  \langle A\rangle
  ...
  \,\underbrace{e^{\frac{i}{\hbar}
        H_0(t-t_0)}A_S\,e^{-\frac{i}{\hbar}H_0(t-t_0)}}_{\text{Operator }A_0(t)\text{ im WW-Bild}} \,\underbrace{|\phi_0(t)\rangle}_{\text{Zustand im WW-Bild}}.
\end{equation}
Dabei haben wir im Prinzip zwei Einsen eingefügt und benutzt, dass:
\begin{equation}
  |\phi_0(t)\rangle=e^{\frac{i}{\hbar}
      H_0(t-t_0)}|\phi_S(t)\rangle.
\end{equation}
Nun folgt die Bewegungsgleichung im WW-Bild direkt durch Ableiten:
\begin{equation}
  \begin{aligned}
    i\hbar\,\frac{\partial}{\partial t}|\phi_0(t)\rangle
     & = i\hbar\,\frac{\partial}{\partial t}\left(e^{\frac{i}{\hbar}
    H_0(t-t_0)}|\phi_S(t)\rangle\right)                                                                                                                     \\
     & = -H_0e^{\frac{i}{\hbar}H_0(t-t_0)}|\phi_S(t)\rangle +e^{\frac{i}{\hbar}H_0(t-t_0)}\left(i\hbar\,\frac{\partial}{\partial t}|\phi_S(t)\rangle\right) \\ & = -H_0e^{\frac{i}{\hbar}H_0(t-t_0)}|\phi_S(t)\rangle +e^{\frac{i}{\hbar}H_0(t-t_0)}(H_0+H_{\mathrm{int}})|\phi_S(t)\rangle \\ & = e^{\frac{i}{\hbar}H_0(t-t_0)}H_{\mathrm{int}}|\phi_S(t)\rangle \\ & = e^{\frac{i}{\hbar}H_0(t-t_0)}H_{\mathrm{int}}e^{-\frac{i}{\hbar}H_0(t-t_0)}|\phi_0(t)\rangle \\      & = \underbrace{e^{\frac{i}{\hbar}H_0(t-t_0)}H_{\mathrm{int}}e^{-\frac{i}{\hbar}H_0(t-t_0)}}_{\equiv\,H_{\mathrm{int}}^{(0)}(t)}|\phi_0(t)\rangle.
  \end{aligned}
\end{equation}
...
\begin{equation}
  \begin{aligned}
    |\phi_0(t_2)\rangle
     & = \lim \limits_{\delta t \to 0}\cdots e^{-\frac{i}{\hbar}H_{\mathrm{int}}^{(0)}(t_{a})\delta t}e^{-\frac{i}{\hbar}H_{\mathrm{int}}^{(0)}(t_1)\delta t}\cdots|\phi_0(t_1)\rangle, \\
     & =\lim \limits_{\delta t \to 0}\mathcal T\prod_{t_i=t_1}^{t_2-\delta t}e^{-\frac{i}{\hbar}H_{\mathrm{int}}^{(0)}(t_i)\delta t}|\phi_0(t_1)\rangle,
  \end{aligned}
\end{equation}
