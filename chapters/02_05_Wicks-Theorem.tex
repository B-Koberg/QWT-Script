...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.8\textwidth]{temp_diagrams/Feynman_for_Coulomb.png}
  \caption{Feynman-Diagramme für die Terme a) bis f) in der Entwicklung von $G^{(1)}(1,2)$.}
  \label{fig:Feynman_Diagramm}
\end{figure}

\lend{Vorl. 04.05.2026}[Vorl. 08.05.2026]
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.8\textwidth]{temp_diagrams/chem_feynman_1Ordnung.png}
...
\lend{Vorl. 08.05.2026}[Vorl. 11.05.2026]

\clearpage
\includepdf[pages=1,pagecommand={},fitpaper=true]{PDF/11_Feynman-Diagramme_2._Ordnung.pdf}
\clearpage
